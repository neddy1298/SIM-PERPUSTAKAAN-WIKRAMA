                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control form-control-sm"
                                                   value="{{$books->pengarang}}" name="pengarang"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control form-control-sm"
                                                   name="penerbit"
                                                   value="{{$books->penerbit}}" id="formGroupExampleInput"
                                                   placeholder="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="margin-bottom: 2%;">
                                        ...
                                        <img id="preview_gambar"
                                             src="{{ asset('asset') }}/upload/ebook/{{$books->cover}}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select custom-select-sm mr-sm-2" name="id_kategori"
                                                    required id="id_kategori">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-warning"
                                                style="height: 40px;font-size: 13px;width: 100px">UPDATE
                                        </button>
