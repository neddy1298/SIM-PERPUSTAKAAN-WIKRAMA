                        ...
                        <div class="col-md-2 mt-3">
                            <div class="form-group">
                                <div class="input-group ">
                                    <a href="{{url('admin/ebook/create')}}" class="btn btn-primary btn-sm">Tambah
                                        E-Book</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" ria-labelledby="dropdownMenu2">
                                                <a class="dropdown-item" href="ebook/{{$book->id}}/edit"
                                                   style="font-size: 12px">Edit</a>
                                                <a class="dropdown-item" href="/ebook/{{$book->id}}/delete"
