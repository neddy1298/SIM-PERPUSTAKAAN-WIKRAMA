                        ...
                        <div class="col-md-1 mt-3" style="padding-right: 10%;">
                            <div class="form-group">
                                <div class="input-group ">
                                    <a href="{{url('admin/etube/create')}}" class="btn btn-sm btn-primary">Add
                                        E-Tube</a>
                                </div>
                            </div>
                        </div>
                    ...
                    " width="120px" height="68px" alt="">
                                    ...
                                    <td>
                                        ...
                                        <p style="font-size: 12px"
                                           class="jdl-yt">{!! substr($tube->deskripsi , 0,50) !!} ...</p>
                                    </td>
                                    <td>
                                        {{ $tube->author }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" ria-labelledby="dropdownMenu2">
                                                <a class="dropdown-item" href="etube/{{$tube->id}}/edit"
                                                   style="font-size: 12px">Edit</a>
                                                <a class="dropdown-item" href="/etube/{{$tube->id}}/delete"
