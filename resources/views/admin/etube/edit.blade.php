                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col" style="margin-bottom: 2%">
                            <h3 class="mb-0">Tambah Vidio Baru</
                            <h3>
                        </div>
                    ...
                    <!-- COntent -->
                    <form action="{{route('etube.update',$etube->id) }}" method="POST" style="margin-left: 1.3%">
                        @csrf
                        @method('PUT')
                        @if($errors->count() > 0)
                            <ul>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" class="form-control form-control-sm"
                                           id="formGroupExampleInput" required value="{{ $etube->judul }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="author" class="form-control form-control-sm"
                                           id="formGroupExampleInput" required value="{{ $etube->author }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" class="form-control form-control-sm"
                                           id="formGroupExampleInput" required value="{{ $etube->link }}">
                                    <span style="font-size: 12px;">Ex.https://www.youtu.be/<b>TEO7QcXZs7E</b></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="formGroupExampleInput" class="label">Category</label>
                                    <select class="custom-select custom-select-sm mr-sm-2" name="id_kategori" required
                                            id="id_kategori">
                                        <option selected hidden value="{{ $etube->id_kategori }}">
                                            {{ $etube->nama_kategori }}
                                            {{ $etube->nama_kategori }}</option>
                                ...
                                <div class="row" style="margin-top: 1%;">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-primary"
                                                style="height: 40px;font-size: 13px;width: 100px">Submit
                                        </button>
