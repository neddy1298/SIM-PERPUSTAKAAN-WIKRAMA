                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" ria-labelledby="dropdownMenu2">
                                                <button class="dropdown-item" style="font-size: 12px"
                                                        data-toggle="modal"
                                                        data-target="#edit-kategori-{{$kategori->id_kategori}}">Edit
                                                </button>
                                                <button class="dropdown-item" style="font-size: 12px"
                                                        data-toggle="modal"
                                                        data-target="#hapus-kategori-{{$kategori->id_kategori}}">Delete
                                                </button>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <div class="card bg-secondary shadow border-0">
                                    <div class="card-body px-lg-5 py-lg-5">
                                        ...
                                        <form role="form" method="POST"
                                              action="/admin/kategori/{{$kategori->id_kategori}}/edit"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label">Nama Kategori</label>
                                                        <input type="nama_kategori" class="form-control"
                                                               id="nama_kategori" name="nama_kategori" require
                                                               autocomplete="off"
                    ...
                    <div class="modal-content bg-gradient-danger">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-danger ml-auto"
                               href="/admin/kategori/{{ $kategori->id_kategori }}/delete">Hapus</a>
                        </div>
