                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" class="form-control form-control-sm"
                                                   id="formGroupExampleInput" required value="{{ $user->password }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="col-4">
                                <div class="row">
                                    <div class="col-md-12" style="margin-bottom: 2%;">
                                        ...
                                        <img src="{{ asset('asset') }}/upload/users/{{$user->img_profile}}"
