                    ...
                    @foreach($books as $book)
                        <div class="single-post row">
                            <div class="col-lg-3  col-md-3 meta-details">
                                <ul class="tags">
                                    <li>tags: <a class="badge" href="#">{{ $book->nama_kategori }}</a></li>
                                </ul>
                                <div class="user-details row">
                                    <p class="user-name col-lg-12 col-md-12 col-6"><a
                                            href="#">{{ $book->pengarang }}</a> <span
                                            class="lnr lnr-user"></span></p>
                                    <p class="view col-lg-12 col-md-12 col-6"><a
                                            href="#">{{ $book->created_at->formatLocalized('%d %B, %Y') }}</a> <span
                                            class="lnr lnr-calendar-full"></span></p>
                                    <p class="view col-lg-12 col-md-12 col-6"><a href="#">{{ $book->views }} Views</a>
                                        <span
                            ...
                            <div class="col-lg-9 col-md-9 ">
                                <div class="text-center">
                                    <img class="img-fluid" src="{{ asset('asset') }}/upload/ebook/{{ $book->cover }}"
                                         alt=""
                                         width="200px">
                                </div>
                                ...
                                {!! $book->deskripsi !!}
                                <a href="{{ route('perpustakaan_e-book_detail', $book->id) }}" class="primary-btn">View
                                    More</a>
                            </div>
                        </div>
                    @endforeach
