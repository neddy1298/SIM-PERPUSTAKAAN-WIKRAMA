                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post row">
                        ...
                        <div class="col-lg-3  col-md-3 meta-details">
                            <ul class="tags">
                                <li>tags: <a class="badge" href="#">{{ $tubes->nama_kategori }}</a></li>
                            </ul>
                            <div class="user-details row">
                                <p class="user-name col-lg-12 col-md-12 col-6"><a href="#">{{ $tubes->author }}</a>
                                    <span
                                ...
                                <p class="view col-lg-12 col-md-12 col-6"><a href="#">{{ $tubes->views }} Views</a>
                                    <span
