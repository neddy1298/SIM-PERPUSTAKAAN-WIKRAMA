@if ($paginator->hasPages())
    <nav>
        <ul class="blog-pagination justify-content-center d-flex">
            ...
            @else
                <li class="page-item">
                    <a class="page-link lnr lnr-chevron-left" href="{{ $paginator->previousPageUrl() }}" rel="prev"
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <a class="page-link lnr lnr-chevron-right" href="{{ $paginator->nextPageUrl() }}" rel="next"
